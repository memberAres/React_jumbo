            ...
            <ul className="sub-menu">
              <li>
                <NavLink className="prepend-icon" to="/app/dashboard/crypto">
                  <span className="nav-text"><IntlMessages id="HOME"/></span>
                </NavLink>
              </li>
              <li>
                <NavLink className="prepend-icon" to="/app/dashboard/listing">
                  <span className="nav-text"><IntlMessages id="PROFILE"/></span>
                </NavLink>
              </li>
              <li>
                <NavLink className="prepend-icon" to="/app/dashboard/crm">
                  <span className="nav-text"><IntlMessages id="SEARCH"/></span>
                </NavLink>
              </li>
              <li>
                <NavLink className="prepend-icon" to="/app/dashboard/intranet">
                  <span className="nav-text"><IntlMessages id="ABOUT"/></span>
                </NavLink>
              </li>
              {/* <li>
              ...
              <li>
                <NavLink className="prepend-icon" to="/app/dashboard/faq">
                  <span className="nav-text"><IntlMessages id="FAQ"/></span>
                </NavLink>
              </li>
            </ul>
          </li>
